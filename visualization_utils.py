...
def draw_bounding_box_on_image(bikemode,
  ...
  cnt=xmax
  path=os.getcwd()+'\\car'
  path2=os.getcwd()+'\\motorcycle'
  arr = ['car', 'truck', 'bicycle', 'bus', 'motorcycle']
...
def visualize_boxes_and_labels_on_image_array(bikemode,
                                              sess,
                                              image,
                                              boxes,
                                              classes,
                                              ...
                                              line_thickness=4):
  image_np = image
  fheight, fwidth = image_np.shape[:2]
  if bikemode==False:
      cv2.line(image_np, (0, int(1 * fheight / 2)), (fwidth, int(1 * fheight / 2)), (0, 255, 0), 1)
      cv2.line(image_np, (0, int(1 * fheight / 2) + 5), (fwidth, int(1 * fheight / 2) + 5), (0, 255, 0), 1)
  else:
      cv2.line(image_np, (0, int(1 * fheight / 2)), (fwidth, int(1 * fheight / 2)), (255, 255, 0), 1)
      cv2.line(image_np, (0, int(1 * fheight / 2) + 5), (fwidth, int(1 * fheight / 2) + 5), (255, 255, 0), 1)
